...
| <a id="hooks"></a> `hooks` | `RouterRouteHooks`[] | **`Internal`** The stores for routes including ancestors. Order of routes will be from greatest ancestor to narrowest matched. |
