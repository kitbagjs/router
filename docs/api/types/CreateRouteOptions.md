...
| <a id="hash"></a> `hash?` | `string` \| `WithParams` | Hash part of URL. |
...
| <a id="path"></a> `path?` | `string` \| `WithParams` | Path part of URL. |
...
| <a id="query"></a> `query?` | `string` \| `WithParams` | Query (aka search) part of URL. |
