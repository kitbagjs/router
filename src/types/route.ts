...
export type Route<
  ...
  TParent extends CreateRouteOptions = CreateRouteOptions
> = {
  /**
  ...
  */
  matched: CreateRouteOptions<TName, TPath, TQuery, THash, TMeta>,
  /**
   * The specific route properties that were matched in the current route, including any ancestors.
   * Order of routes will be from greatest ancestor to narrowest matched.
  */
  matches: (TParent | CreateRouteOptions<TName, TPath, TQuery, THash, TMeta>)[],
  /**
