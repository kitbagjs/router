...
> = (route: ResolvedRoute<TRoute> & WithData<TRoute>, context: AddViewPropsCallbackContext<TRoute>) => MaybePromise<ComponentProps<TComponent>>
...
export type AddViewOptions<
  ...
  TGetter = PropsGetter
> = TransformerOptions<PayloadValueOf<TGetter>> & {
  /**
