  ...
  const router = createRouter(
    [
      createRoute({
        ...
        path: "/routeA",
        component: {
          render: () => h(RouterLink, { to: (resolve) => resolve("routeB"), ...propOptions }),
        },
      }),
      createRoute({
        name: "routeB",
  ...
  const router = createRouter(
    [
      createRoute({
        ...
        path: "/routeA",
        component: {
          render: () => h(RouterLink, { to: (resolve) => resolve("routeB", {}, resolveOptions) }),
        },
      }),
      createRoute({
        name: "routeB",
    ...
    [
      createRoute({
        ...
        component: {
          render: () =>
            h(RouterLink, {
              to: (resolve) => resolve("routeB", {}, resolveOptions),
              ...propOptions,
            }),
        },
      }),
  ...
  const router = createRouter(
    [
      createRoute({
        ...
        path: "/routeA",
        component: {
          render: () => h(RouterLink, { to: (resolve) => resolve("routeB"), target: "_blank" }),
        },
      }),
      createRoute({
        name: "routeB",
...
test.each<{ to: UrlString; match: boolean; exactMatch: boolean }>([
  ...
  "isMatch and isExactMatch classes and slot props works as expected",
  async ({ to, match, exactMatch }) => {
...
test.each<{ to: UrlString; active: boolean; exactActive: boolean }>([
  ...
  "isActive and isExactActive classes and slot props work as expected",
  async ({ to, active, exactActive }) => {
    const parentRoute = createRoute({
      name: "parent-route",
      path: "/parent-route",
    });
...
test.each([[true], [false]])("isExternal slot prop works as expected", async (isExternal) => {
  const parentRoute = createRoute({
    name: "parent-route",
    path: "/parent-route",
  });
