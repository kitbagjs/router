...
describe("stringify", () => {
  ...
  test.each(["?bar=123", "bar=123"])(
    "given parts with query, returns value with query",
    (query) => {
      const parts = {
        host: "https://kitbag.dev",
        query,
  ...
  test.each([{ host: "https://router.kitbag.dev" }, { host: "https://github.io" }])(
    "given parts with host, returns value that satisfies Url",
    (parts) => {
      const url = createUrl(parts);
...
describe("parse", () => {
  test.each([
    ...
    [
      withParams("/[foo]", { foo: /[\d{3}]/ }),
      "/abc",
      'Expected value to match regex /[\\d{3}]/, received "abc"',
    ],
    [withParams("/[foo]", { foo: "def" }), "/abc", 'Expected value to be def, received "abc"'],
  ])(
    "given invalid url $1, throws InvalidRouteParamValueError with useful error message $2",
    (path, input, output) => {
      const url = createUrl({
        path,
      });
...
describe("url assembly", () => {
  describe("path params", () => {
    test.each([["/simple"], [withParams("/simple", {})]])(
      "given simple route with string path and without params, returns route path",
      (path) => {
        const url = createUrl({
          name: "simple",
          path,
    ...
    test.each([
      ...
      "given route with optional string param NOT provided, returns route Path with string without values interpolated",
      (path) => {
        const url = createUrl({
          name: "simple",
          path,
    ...
    test.each([["/simple/[?simple]"], [withParams("/simple/[?simple]", { simple: String })]])(
      "given route with optional string param provided, returns route Path with string with values interpolated",
      (path) => {
        const url = createUrl({
          name: "simple",
          path,
    ...
    test.each([["/simple/[simple]"], [withParams("/simple/[simple]", { simple: String })]])(
      "given route with required string param NOT provided, throws InvalidRouteParamValueError",
      (path) => {
        const url = createUrl({
          name: "simple",
          path,
    ...
    test.each([["/simple/[simple]"], [withParams("/simple/[simple]", { simple: String })]])(
      "given route with required string param provided, returns route Path with string with values interpolated",
      (path) => {
        const url = createUrl({
          name: "simple",
          path,
  ...
  describe("query params", () => {
    test.each([["simple=abc"], [withParams("simple=abc", {})]])(
      "given simple route with string query and without params, returns route query",
      (query) => {
        const url = createUrl({
          name: "simple",
          path: "/",
    ...
    test.each([["simple=[?simple]"], [withParams("simple=[?simple]", { simple: String })]])(
      "given route with optional string param provided but empty, returns route Query with string without values interpolated",
      (query) => {
        const url = createUrl({
          name: "simple",
          path: "/",
    ...
    test.each([["simple=[?simple]"], [withParams("simple=[?simple]", { simple: String })]])(
      "given route with optional string param provided, returns route Query with string with values interpolated",
      (query) => {
        const url = createUrl({
          name: "simple",
          path: "/",
    ...
    test.each([["simple=[simple]"], [withParams("simple=[simple]", { simple: String })]])(
      "given route with required string param provided, returns route Query with string with values interpolated",
      (query) => {
        const url = createUrl({
          name: "simple",
          path: "/",
  ...
  describe("host params", () => {
    test.each([["https://kitbag.dev"], [withParams("https://kitbag.dev", {})]])(
      "given simple route with string host and without params, returns route host",
      (host) => {
        const url = createUrl({
          name: "simple",
          path: "/",
    ...
    test.each([
      ...
      "given route with optional string param provided, returns route Host with string with values interpolated",
      (host) => {
        const url = createUrl({
          name: "simple",
          path: "/",
    ...
    test("given route with default string param provided, returns route Host with string with values interpolated", () => {
      const url = createUrl({
        name: "simple",
        path: "/",
        host: withParams("https://[?subdomain]kitbag.dev", {
          subdomain: withDefault(String, "abc."),
        }),
      });
    ...
    test.each([
      ...
      "given route with required string param provided, returns route Host with string with values interpolated",
      (host) => {
        const url = createUrl({
          name: "simple",
          path: "/",
  ...
  describe("hash params", () => {
    test.each([["foo"], [withParams("foo", {})]])(
      "given simple route with string hash and without params, returns route hash",
      (hash) => {
        const url = createUrl({
          name: "simple",
          path: "/",
    ...
    test.each([
      ...
      "given route with optional param NOT provided, returns route hash with string without values interpolated",
      (hash) => {
        const url = createUrl({
          name: "simple",
          path: "/",
    ...
    test.each([["foo[?bar]"], [withParams("foo[?bar]", { bar: String })]])(
      "given route with optional string param provided, returns route Hash with string with values interpolated",
      (hash) => {
        const url = createUrl({
          name: "simple",
          path: "/",
    ...
    test.each([["foo[bar]"], [withParams("foo[bar]", { bar: String })]])(
      "given route with required string param provided, returns route Hash with string with values interpolated",
      (hash) => {
        const url = createUrl({
          name: "simple",
          path: "/",
