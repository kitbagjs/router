...
test.each([
  ...
  { schema: z.boolean(), string: "true", parsed: true },
  {
    ...
    string: "2022-01-12T00:00:00.000Z",
    parsed: "2022-01-12T00:00:00.000Z",
  },
  ...
  { schema: z.iso.time(), string: "09:52:31", parsed: "09:52:31" },
  {
    schema: z.date(),
    string: "2022-01-12T00:00:00.000Z",
    parsed: new Date("2022-01-12T00:00:00.000Z"),
  },
  { schema: z.object({ foo: z.string() }), string: '{"foo":"bar"}', parsed: { foo: "bar" } },
  {
    schema: z.object({ foo: z.string().nullable() }),
    string: '{"foo":null}',
    parsed: { foo: null },
  },
  ...
  { schema: z.email(), string: "test@example.com", parsed: "test@example.com" },
  {
    ...
    parsed: "123e4567-e89b-12d3-a456-426614174000",
  },
  ...
  {
    schema: z.union([z.string(), z.object({ foo: z.string() })]),
    string: '{"foo":"bar"}',
    parsed: { foo: "bar" },
  },
  {
    schema: discriminatedUnion,
    string: '{"type":"one","value":"foo"}',
    parsed: { type: "one", value: "foo" },
  },
  {
    schema: discriminatedUnion,
    string: '{"type":"two","value":1}',
    parsed: { type: "two", value: 1 },
  },
  {
    schema: z.record(z.string(), z.object({ foo: z.string() })),
    string: '{"one":{"foo":"bar"}}',
    parsed: { one: { foo: "bar" } },
  },
...
test.each([
  {
    schema: z.intersection(z.object({ foo: z.string() }), z.object({ bar: z.number() })),
    type: "Intersection",
  },
