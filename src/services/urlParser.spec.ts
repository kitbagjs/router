...
describe("updateUrl", () => {
  test.each([
    ...
    "given previous host (%s) and updated host (%s), returns updated host",
    (previous, updated) => {
  ...
  test.each([
    ...
    "given previous path (%s) and updated path (%s), returns updated path",
    (previous, updated) => {
      const url = updateUrl(previous, updated);
  ...
  test.each([
    ...
    "given previous query (%s) and updated query (%s), returns updated query",
    (previous, updated) => {
      const url = updateUrl(previous, updated);
  ...
  test.each([
    ...
    "given previous hash (%s) and updated hash (%s), returns updated hash",
    (previous, updated) => {
      const url = updateUrl(previous, updated);
