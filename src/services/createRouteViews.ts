...
/**
 * The names of the views that have a props getter. A view without one is never computed, so waiting on it
 * would never settle.
 */
export function viewNamesWithProps(views: RouteViews): string[] {
